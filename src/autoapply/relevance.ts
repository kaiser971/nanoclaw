...
function scoreLocationMatch(location: string | null, profile: Profile): number {
...
function scoreTjmMatch(dailyRate: number | null, profile: Profile): number {
 ...
 */
function isHardExcluded(offer: RawOffer, excludedSkills: Set<string>): boolean {
...
export function scoreOffer(offer: RawOffer, profile?: Profile): ScoringResult {
